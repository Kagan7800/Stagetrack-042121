...
class Meeting extends Component<MeetingProps> {
  ...
  video(video: VideoState) {
    return (
      <IonCol style={{ overflow: 'scroll', width: '50%', display: 'block', float: 'left', border: '8px solid green', padding: 0 }} key={video.id}>
              ...
              <div id='container'>
                ...
                {/* <div className={styles.main_container}>
                  <div className={styles.banner}>
                    <img className={styles.banner_image} src='./assets/banner.png' alt='' />
                  </div>
                  <div className={styles.grid_container}>
                    <div className={styles.item8}>
                      <div className={styles.screen_sharing_box}></div>
                    </div>
                    {Array(29)
                      .fill(1)
                      .map((item, index) =>
                ...
                {/* <main>
                    ...
                    <div id='newMainContentAreaX1'>
                      <div className='newMainContentHeaderBg'>
                        <IonImg src='/assets/image1190.png' className='newMainContentHeaderLogo' />
                        <h6 className='newMainContentHeaderPresents'>Presents</h6>
                        <h5 className='newMainContentHeaderPerformance'>Performance</h5>
                      </div>
                      <div className='newMainContentMain'>
                        <div className='newMainContentLeft'>{this.videosFirst}</div>
                        ...
                        <div className='newMainContentRightX8'>{this.videos}</div>
                      </div>
                    </div>
                  </div>
                </main> */}
